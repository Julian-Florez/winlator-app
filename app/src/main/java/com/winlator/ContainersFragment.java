...
public class ContainersFragment extends Fragment {
    ...
    private void updateLayoutManager() {
        ...
        int spanCount = getResources().getInteger(R.integer.container_list_span_count);
        if (spanCount > 1) recyclerView.setLayoutManager(new GridLayoutManager(context, spanCount));
        else recyclerView.setLayoutManager(new LinearLayoutManager(context));
    }
