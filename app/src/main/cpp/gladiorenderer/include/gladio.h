...
#ifndef WINLATOR_X11_SERVER_PATH
#define WINLATOR_X11_SERVER_PATH "/data/data/com.winlator/files/rootfs/tmp/.X11-unix/X0"
#endif
#define X11_SERVER_PATH WINLATOR_X11_SERVER_PATH
