...
#ifndef WINLATOR_VORTEK_SERVER_PATH
#define WINLATOR_VORTEK_SERVER_PATH "/data/data/com.winlator/files/rootfs/tmp/.vortek/V0"
#endif
#define VORTEK_SERVER_PATH WINLATOR_VORTEK_SERVER_PATH
